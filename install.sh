...
for script in detect.py tick.sh engineer.sh review.sh merge.sh dependabot_merge.sh release.sh release_lib.sh cli_dispatch.sh gc_worktrees.sh parse_toml.py; do
